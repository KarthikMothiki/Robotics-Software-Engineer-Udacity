...
│   ├── video_gif.gif                          # video
```
- [drive_bot.cpp](Robotics-Software-Engineer-Udacity/Project2 Go Chase It/ball_chaser/src/drive_bot.cpp): ROS service C++ script, command the robot with specify speeds.  
